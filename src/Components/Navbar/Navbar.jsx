        ...
        <div className="navbar p-0 justify-between rounded-xl bg-base-100">
            ...
            <div className="h-14 w-80 rounded-lg flex justify-center items-center">
                <div className="relative w-full">
                    <input className="block p-2.5 w-full h-14 z-20 text-sm text-gray-800 bg-base-100 rounded-xl border-2 border-base-300 focus:ring-base-300 focus:border-base-300" placeholder="Search..." required />
                    <button type="submit" className="btn shadow-none absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-gray-800 bg-base-300 rounded-r-xl  border border-base-300 hover:text-white focus:ring-base-300">
